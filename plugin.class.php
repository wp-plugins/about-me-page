			...
			<div class="col-sm-6">
				<div class="panel panel-<?php echo $options['wcp_about_me_themes'] ?>">
				  ...
				  <div class="panel-body">
				  	<?php if ($options['wcp_about_me_skills_1'] != '') { ?>
				  		<div class="progress">
						  <div class="progress-bar progress-bar-striped active progress-bar-<?php echo $options['wcp_about_me_themes'] ?>" data-level="<?php echo $options['wcp_about_me_skills_1_level'] ?>">
				  	...
				  	<?php if ($options['wcp_about_me_skills_2'] != '') { ?>
				  		<div class="progress">
						  <div class="progress-bar progress-bar-striped active progress-bar-<?php echo $options['wcp_about_me_themes'] ?>" data-level="<?php echo $options['wcp_about_me_skills_2_level'] ?>">
				  	...
				  	<?php if ($options['wcp_about_me_skills_3'] != '') { ?>
				  		<div class="progress">
						  <div class="progress-bar progress-bar-striped active progress-bar-<?php echo $options['wcp_about_me_themes'] ?>" data-level="<?php echo $options['wcp_about_me_skills_3_level'] ?>">
				  	...
				  	<?php if ($options['wcp_about_me_skills_4'] != '') { ?>
				  		<div class="progress">
						  <div class="progress-bar progress-bar-striped active progress-bar-<?php echo $options['wcp_about_me_themes'] ?>" data-level="<?php echo $options['wcp_about_me_skills_4_level'] ?>">
				  	...
				  	<?php if ($options['wcp_about_me_skills_5'] != '') { ?>
				  		<div class="progress">
						  <div class="progress-bar progress-bar-striped active progress-bar-<?php echo $options['wcp_about_me_themes'] ?>" data-level="<?php echo $options['wcp_about_me_skills_5_level'] ?>">
